...
This is a sample template for scottcraigwebsite - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name scottcraigwebsite --tail
```
...
```bash
aws cloudformation delete-stack --stack-name scottcraigwebsite
```
